...
unsigned char TxCounter1 = 0;
unsigned char TxCounter3 = 0;
unsigned char TxCounter4 = 0;
unsigned char count1 = 0;
unsigned char count3 = 0;
unsigned char count4 = 0;
unsigned char Rx1_Temp = 0;
unsigned char Rx3_Temp = 0;
/* USER CODE END 0 */
...
{
  TxBuffer1[count1++] = DataToSend;               //���潫Ҫ���͵�����
  __HAL_UART_ENABLE_IT(&huart1, UART_IT_TXE); 		//�����ж�
}
...
{
  TxBuffer3[count3++] = DataToSend;               //���潫Ҫ���͵�����
  __HAL_UART_ENABLE_IT(&huart3, UART_IT_TXE); 		//�����ж�
}
